...
export const archiveMetadataManifest = {
  ...
  formats: [
    ...
    { name: { en: "RAR archive", "zh-CN": "RAR 归档" }, extensions: [".rar"], mimeTypes: ["application/vnd.rar"] },
    { name: { en: "TAR archive", "zh-CN": "TAR 归档" }, extensions: [".tar"], mimeTypes: ["application/x-tar"] },
