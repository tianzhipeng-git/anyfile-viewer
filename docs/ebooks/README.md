...
- 状态：阶段 0–5 已交付；新增无 DRM MOBI/PalmDOC/KF8 和 CBR/CB7/CBT，组合边界见支持矩阵
...
已交付 EPUB 2/3、CBZ 与 FB2 的本地阅读；EPUB、FB2 和 MOBI 共用最小章节阅读层；已扩展 MOBI/PalmDOC/KF8 与 CBR/CB7/CBT；后续为 DjVu 和 CHM。PDF、TXT、HTML 等已有路径不重复实现，受 DRM 保护的内容明确不支持解密。
