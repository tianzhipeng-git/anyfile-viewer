...
- 状态：阶段 0–3 首批交付已完成；EPUB 2/3 reflowable、CBZ 与 FB2 已实现并通过固定语料/生产浏览器验收
...
已交付 EPUB 2/3、CBZ 与 FB2 的本地阅读；EPUB 和 FB2 共用最小章节阅读层；后续分别 spike MOBI/AZW、CBR/CB7/CBT、DjVu 和 CHM。PDF、TXT、HTML 等已有路径不重复实现，受 DRM 保护的内容明确不支持解密。
