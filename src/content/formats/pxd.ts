...
export const pxdFormat = defineFormat("pxd", "graphic-design", 2,
  {
    ...
    description: "Preview the saved image in a Pixelmator Pro PXD file without installing Pixelmator.",
  ...
  },
  {
    ...
    description: "无需安装 Pixelmator，即可预览 Pixelmator Pro PXD 文件中保存的图片。",
