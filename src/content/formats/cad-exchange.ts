...
export const cadExchangeFormats = ["step", "stp", "iges", "igs", "brep"].map(extension => defineFormat(extension, "engineering", 3, {
  name: extension.toUpperCase(), title: `View ${extension.toUpperCase()} CAD Files Online`, description: `View supported ${extension.toUpperCase()} CAD models, rotate them and zoom in on details.`,
  ...
  name: extension.toUpperCase(), title: `在线查看 ${extension.toUpperCase()} CAD 文件`, description: `查看受支持的 ${extension.toUpperCase()} CAD 模型，旋转模型并放大查看细节。`,
