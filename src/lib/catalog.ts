...
export const formats: FileFormat[] = [
  ...
  { extension: "mp4", name: "MP4 媒体", description: "按轨道内容分流，本地播放已验证的视频组合或 AAC-LC audio-only 文件。", category: "images-video", native: true },
  { extension: "webm", name: "WebM 媒体", description: "按轨道内容分流，本地播放已验证的视频或 Opus/Vorbis audio-only 文件。", category: "images-video", native: true },
  ...
  { extension: "mk3d", name: "Matroska 3D 视频", description: "通过本地 WebCodecs 播放 Matroska 3D 容器中的已支持主视频与音轨组合。", category: "images-video", native: false },
  { extension: "mp3", name: "MP3 音频", description: "在浏览器中直接播放 CBR 与 Xing/VBRI VBR MP3。", category: "images-video", native: true },
  { extension: "wav", name: "WAVE 音频", description: "播放 PCM S16LE、S24LE 与 F32LE WAVE 音频。", category: "images-video", native: true },
  { extension: "m4a", name: "M4A 音频", description: "播放 MPEG-4 容器中的 AAC-LC audio-only 文件。", category: "images-video", native: true },
  { extension: "ogg", name: "Ogg 媒体", description: "按内容播放 Ogg Vorbis、Opus 音频或 Theora 视频。", category: "images-video", native: true },
  { extension: "opus", name: "Opus 音频", description: "播放 Ogg 封装的 Opus 音频。", category: "images-video", native: true },
  { extension: "flac", name: "FLAC 音频", description: "播放 16/24-bit mono/stereo native FLAC。", category: "images-video", native: true },
  { extension: "aac", name: "ADTS AAC 音频", description: "在已验证环境中播放 AAC-LC ADTS 裸码流。", category: "images-video", native: true },
  { extension: "mka", name: "Matroska 音频", description: "通过本地 WebCodecs 与 Web Audio 播放单主音轨 Matroska 音频。", category: "images-video", native: false },
  ...
  { extension: "npy", name: "NumPy 数组", description: "分页查看数值、布尔、字符串和结构化数组，不反序列化对象。", category: "developer-artifacts", native: false },
  { extension: "npz", name: "NumPy 数组归档", description: "浏览归档内数组，并按需流式读取选中数组的数据页。", category: "developer-artifacts", native: false },
  { extension: "wasm", name: "WebAssembly 模块", description: "检查模块段、类型、导入导出、内存、表和函数体大小，不实例化模块。", category: "developer-artifacts", native: false },
  { extension: "map", name: "Source Map", description: "查看 sources、names、内嵌源码与映射覆盖，并查询生成位置对应的原始位置。", category: "developer-artifacts", native: false },
  { extension: "jar", name: "JAR 软件包", description: "查看 Java 归档的文件目录和容器信息。", category: "developer-artifacts", native: false },
  { extension: "whl", name: "Python Wheel", description: "查看 Wheel 软件包的文件目录和容器信息。", category: "developer-artifacts", native: false },
  { extension: "nupkg", name: "NuGet 软件包", description: "查看 NuGet 软件包的文件目录和容器信息。", category: "developer-artifacts", native: false },
  { extension: "tgz", name: "npm 包归档", description: "流式读取 gzip 内部 TAR 的文件目录，不执行包内脚本。", category: "developer-artifacts", native: false },
  { extension: "crate", name: "Rust crate", description: "流式读取 crate 内部 TAR 的文件目录。", category: "developer-artifacts", native: false },
  { extension: "jmod", name: "Java JMOD", description: "查看 JMOD 容器内的文件目录。", category: "developer-artifacts", native: false },
...
export const categories: FileCategory[] = [
  { slug: "images-video", name: "图片与音视频", eyebrow: "看见并听见每个细节", description: "通过浏览器原生能力或本地解码查看图片与音视频。", extensions: ["png", "apng", "jpg", "gif", "webp", "avif", "jxl", "heic", "dng", "cr2", "cr3", "crw", "nef", "nrw", "arw", "sr2", "srf", "raf", "orf", "pef", "rwl", "raw", "rw2", "tga", "pnm", "tiff", "svg", "mp4", "webm", "mov", "3gp", "mkv", "mk3d", "mp3", "wav", "m4a", "ogg", "opus", "flac", "aac", "mka"] },
  ...
  { slug: "developer-artifacts", name: "开发者产物", eyebrow: "看清编译与打包结果", description: "在本地检查数组、软件包和工具链产物，不执行其中的代码。", extensions: ["npy", "npz", "wasm", "map", "jar", "whl", "nupkg", "tgz", "crate", "jmod"] },
