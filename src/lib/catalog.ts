...
export const formats: FileFormat[] = [
  ...
  { extension: "json", name: "JSON 数据", description: "结构化查看、折叠与搜索 JSON。", category: "code-data", native: true },
  { extension: "csv", name: "CSV 数据", description: "以表格方式浏览分隔符数据。", category: "code-data", native: true },
...
export const categories: FileCategory[] = [
  ...
  { slug: "code-data", name: "代码与数据", eyebrow: "让结构清晰可见", description: "检查文本、代码和结构化数据，适合快速排错与校验。", extensions: ["md", "json", "csv", "html"] },
