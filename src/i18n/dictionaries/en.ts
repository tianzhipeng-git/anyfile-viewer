...
const dictionary = {
  ...
  viewer: {
    ...
    openFailedFallback: "Unable to open this file.", viewerLabel: "Viewer", supportLevelLabel: "Support level {level}",
    supportLevelDescriptions: [
      "Anyfile cannot meaningfully open this file yet. This reflects missing viewer support, not a damaged or problematic file.",
      "Anyfile can currently inspect only the underlying bytes, metadata, or structure. This reflects limited viewer capability, not poor file quality or problematic content.",
      "Anyfile can currently show only a thumbnail, summary, or representative content. This reflects incomplete viewer capability, not poor file quality or problematic content.",
      "The main content is viewable, but some significant format capabilities are not covered.",
      "The main content and common format semantics are fully viewable within the declared support scope.",
      "The main content is fully viewable, with domain-specific navigation or interaction needed to understand the format.",
    ],
